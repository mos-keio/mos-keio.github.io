(function(d,b,w){
	...
	'.y1{-webkit-animation:v1 10s 5s;animation:v1 10s 5s;}'+
	'.y2{-webkit-animation:v2 10s 5s;animation:v2 10s 5s;}'+
	'.y3{-webkit-animation:v3 9s 5s;animation:v3 9s 5s;}'+
	'.y4{-webkit-animation:v4 9s 5s;animation:v4 9s 5s;}'+
	'.y5{-webkit-animation:v5 8s 5s;animation:v5 8s 5s;}'+
	'.y6{-webkit-animation:v6 8s 5s;animation:v6 8s 5s;}'+
	'@-webkit-keyframes v1{'+
